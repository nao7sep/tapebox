...
// and since Safari 27 so does focus a script moves after keyboard use. Every scroll
// region — the main pane, the detail pane's three, the modal body — took the app's
// own base-layer ring that way.
//
...
// may ring; a container the covering rule in globals.css reaches; or a site listed
...
const COVERING_STYLESHEET = "src/renderer/styles/globals.css";
